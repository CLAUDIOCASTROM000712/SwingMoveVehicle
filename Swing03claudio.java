...
class MyCanvas extends JPanel implements ActionListener{
    ...
    public MyCanvas () {
        ...
        cars.add(new Car(10, 200, 3, 0, Color.RED, 50, 25));
        cars.add(new Car(10, 150, 4, 0, Color.DARK_GRAY, 40,20));
        cars.add(new Car(10, 100, 5, 0, Color.BLUE, 30, 15) );
    }
    @Override
